...
banner = """
 _                     _   ___ _ _             _   _   ____   __  
| |                   | | / (_) | |           | | | | / ___| /  | 
| |     __ _ _ __ __ _| |/ / _| | | ___ _ __  | | | |/ /___  `| | 
| |    / _` | '__/ _` |    \| | | |/ _ \ '__| | | | || ___ \  | | 
| |___| (_| | | | (_| | |\  \ | | |  __/ |    \ \_/ /| \_/ |__| |_
\_____/\__,_|_|  \__,_\_| \_/_|_|_|\___|_|     \___(_)_____(_)___/

   [+] LARAVEL V6.1
   [+] Recoded By MR.X
   [+] We Are https://xtooler.xyz
	...
	try:
		...
		try:
			...
			try:
				...
				print("List non trouvé ! ")
				exit()
			try:
				numthread = raw_input("vitesse du scan ? 1 & 500 ?")
			except:
				print("vitesse inconnu !")
				exit()
